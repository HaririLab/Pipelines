...
npb=13
sumaDir=$1 ##Path to a subjects suma Directory in All_imaging
image=${sumaDir}/std.60.lh.aparc.a2009s.annot.niml.dset
surf=$(sumaDir}/std.60.FreeSurfer_both.spec
